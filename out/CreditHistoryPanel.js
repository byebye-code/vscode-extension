...
exports.CreditHistoryPanel = void 0;
const vscode = require("vscode");
const https = require("https");
const url_1 = require("url");
class CreditHistoryPanel {
    constructor(context) {
    ...
    async show() {
        ...
        this._panel = vscode.window.createWebviewPanel('creditHistory', '💰 额度变化记录', vscode.ViewColumn.One, {
            enableScripts: true,
    ...
    async loadCreditHistory(pageNum = 1) {
        try {
...
exports.CreditHistoryPanel = CreditHistoryPanel;
//# sourceMappingURL=CreditHistoryPanel.js.map